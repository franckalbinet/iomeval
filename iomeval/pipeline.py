...
# %% auto 0
__all__ = ['logger', 'report_urls', 'Report', 'load_report', 'map_single', 'should_force', 'PipelineResult', 'run_pipeline',
           'get_report_urls', 'get_eval_report_url', 'BatchResult', 'filter_evals', 'is_completed', 'batch_run']

# %% ../nbs/07_pipeline.ipynb 3
...
# %% ../nbs/07_pipeline.ipynb 5
logger = logging.getLogger(__name__)
logging.basicConfig(level=logging.WARNING, format='%(name)s - %(levelname)s - %(message)s')
logger.setLevel(logging.DEBUG)

# %% ../nbs/07_pipeline.ipynb 7
class Report:
...
# %% ../nbs/07_pipeline.ipynb 74
report_urls = get_report_urls()

# %% ../nbs/07_pipeline.ipynb 76
